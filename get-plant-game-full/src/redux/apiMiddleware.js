...
import { logoutAdmin } from "./actions/authActionCreators";


export const apiMiddleware = ({ dispatch, getState }) => next => function (action) {
    ...
    const AUTH_TOKEN = getState().admin.token;
        if(AUTH_TOKEN)
